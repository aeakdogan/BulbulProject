...
notify_slack('Lastfm Album fetcher started(3)')
atexit.register(notify_slack, message='Lastfm Album finished(3)')

skipped_file_count = 0
with open( "outputs/unique_3.txt", 'r') as file:
    for i,line in enumerate(file):
        ...
        if i % 1000 == 0:
            notify_slack('{} # of files are skipped (3)'.format(skipped_file_count))
            notify_slack('{} - (3) Lastfm album info has been downloaded!'.format(i))
