...
notify_slack('Lastfm Album fetcher started(1)')
atexit.register(notify_slack, message='Lastfm Album finished(1)')

skipped_file_count = 0
with open("outputs/unique_1.txt", 'r') as file:
    for i, line in enumerate(file):
        ...
        if i % 1000 == 0:
            notify_slack('{} # of files are skipped (1)'.format(skipped_file_count))
            notify_slack('{} - (1) Lastfm Album info has been downloaded!'.format(i))
