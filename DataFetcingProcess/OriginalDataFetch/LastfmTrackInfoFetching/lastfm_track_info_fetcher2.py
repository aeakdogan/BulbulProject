...
notify_slack('Lastfm Track fetcher started(2)')
atexit.register(notify_slack, message='Lastfm Track finished(2)')

with open( "../outputs/unique_tracks_2.txt", 'r') as file:
