...
public final class ProfileQuery implements Query<ProfileQuery.Data, ProfileQuery.Data, ProfileQuery.Variables> {
  public static final String OPERATION_DEFINITION = "query ProfileQuery($token: String, $id: Int, $limit: Int, $skip: Int, $ids: [Int]) {\n"
  ...
  private final ProfileQuery.Variables variables;

  public ProfileQuery(@Nullable String token, @Nullable Integer id, @Nullable Integer limit,
      @Nullable Integer skip, @Nullable List<Integer> ids) {
    variables = new ProfileQuery.Variables(token, id, limit, skip, ids);
  }
  ...
  @Override
  public ProfileQuery.Data wrapData(ProfileQuery.Data data) {
    return data;
  }

  @Override
  public ProfileQuery.Variables variables() {
    return variables;
  }

  @Override
  public ResponseFieldMapper<ProfileQuery.Data> responseFieldMapper() {
  ...
  public static final class Builder {
    ...
    public ProfileQuery build() {
      return new ProfileQuery(token, id, limit, skip, ids);
    }
  }
  ...
  public static class Data implements Operation.Data {
    ...
    public static class User {
      ...
      private final @Nullable Integer followersCount;

      private final @Nullable Integer followedUsersCount;

      public User(int id, @Nonnull String username, @Nullable String image,
          @Nullable Integer followersCount, @Nullable Integer followedUsersCount) {
        this.id = id;
      ...
      public @Nullable Integer followersCount() {
        return this.followersCount;
      }

      public @Nullable Integer followedUsersCount() {
      ...
      public boolean equals(Object o) {
        ...
        if (o instanceof User) {
          ...
          return this.id == that.id
           ...
           && ((this.followersCount == null) ? (that.followersCount == null) : this.followersCount.equals(that.followersCount))
           && ((this.followedUsersCount == null) ? (that.followedUsersCount == null) : this.followedUsersCount.equals(that.followedUsersCount));
        }
        return false;
      }
      ...
      public int hashCode() {
        ...
        h *= 1000003;
        h ^= (followersCount == null) ? 0 : followersCount.hashCode();
        h *= 1000003;
        h ^= (followedUsersCount == null) ? 0 : followedUsersCount.hashCode();
        return h;
      }
      ...
      public static final class Mapper implements ResponseFieldMapper<User> {
        final Field[] fields = {
          ...
          Field.forInt("followersCount", "followersCount", null, true),
          Field.forInt("followedUsersCount", "followedUsersCount", null, true)
        };
        ...
        public User map(ResponseReader reader) throws IOException {
          ...
          final Integer followersCount = reader.read(fields[3]);
          final Integer followedUsersCount = reader.read(fields[4]);
          return new User(id, username, image, followersCount, followedUsersCount);
        }
      }
    }
  }
