...
public final class FollowingsQuery implements Query<FollowingsQuery.Data, FollowingsQuery.Data, FollowingsQuery.Variables> {
  public static final String OPERATION_DEFINITION = "query FollowingsQuery($token: String, $id: Int, $limit: Int, $skip: Int, $ids: [Int]) {\n"
  ...
  private final FollowingsQuery.Variables variables;

  public FollowingsQuery(@Nullable String token, @Nullable Integer id, @Nullable Integer limit,
      @Nullable Integer skip, @Nullable List<Integer> ids) {
    variables = new FollowingsQuery.Variables(token, id, limit, skip, ids);
  }
  ...
  @Override
  public FollowingsQuery.Data wrapData(FollowingsQuery.Data data) {
    return data;
  }

  @Override
  public FollowingsQuery.Variables variables() {
    return variables;
  }

  @Override
  public ResponseFieldMapper<FollowingsQuery.Data> responseFieldMapper() {
  ...
  public static final class Builder {
    ...
    public FollowingsQuery build() {
      return new FollowingsQuery(token, id, limit, skip, ids);
    }
  }
  ...
  public static class Data implements Operation.Data {
    ...
    public static class FollowedUser {
      ...
      public FollowedUser(int id, @Nonnull String username, @Nullable String image) {
        this.id = id;
      ...
      public boolean equals(Object o) {
        ...
        if (o instanceof FollowedUser) {
          FollowedUser that = (FollowedUser) o;
      ...
      public static final class Mapper implements ResponseFieldMapper<FollowedUser> {
        final Field[] fields = {
        ...
        @Override
        public FollowedUser map(ResponseReader reader) throws IOException {
          final int id = reader.read(fields[0]);
          final String username = reader.read(fields[1]);
          final String image = reader.read(fields[2]);
          return new FollowedUser(id, username, image);
        }
      }
    }

    public static class User {
      private final @Nullable List<FollowedUser> followedUsers;

      public User(@Nullable List<FollowedUser> followedUsers) {
        this.followedUsers = followedUsers;
      }

      public @Nullable List<FollowedUser> followedUsers() {
      ...
      public boolean equals(Object o) {
        ...
        if (o instanceof User) {
          User that = (User) o;
          return ((this.followedUsers == null) ? (that.followedUsers == null) : this.followedUsers.equals(that.followedUsers));
        }
        return false;
      }
      ...
      public int hashCode() {
        int h = 1;
        h *= 1000003;
        h ^= (followedUsers == null) ? 0 : followedUsers.hashCode();
        return h;
      }

      public static final class Mapper implements ResponseFieldMapper<User> {
        final FollowedUser.Mapper followedUserFieldMapper = new FollowedUser.Mapper();

        final Field[] fields = {
          Field.forList("followedUsers", "followedUsers", null, true, new Field.ObjectReader<FollowedUser>() {
            @Override public FollowedUser read(final ResponseReader reader) throws IOException {
              return followedUserFieldMapper.map(reader);
            }
          })
        };
        ...
        public User map(ResponseReader reader) throws IOException {
          final List<FollowedUser> followedUsers = reader.read(fields[0]);
          return new User(followedUsers);
        }
      }
    }
  }
