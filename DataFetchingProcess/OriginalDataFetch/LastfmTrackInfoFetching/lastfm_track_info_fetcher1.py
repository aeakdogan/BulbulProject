...
notify_slack('Lastfm Track fetcher started(1)')
atexit.register(notify_slack, message='Lastfm Track finished(1)')

with open( "outputs/unique_tracks_1.txt", 'r') as file:
